...
;;; @table @asis
;;;
;;; @item Port to R6RS --- 2008-06-27
;;; Derick Eddington ported version 0.16 to R6RS.  The only significant
;;; change is the use of ^ for the SXML attribute node tag instead of @.
;;;
